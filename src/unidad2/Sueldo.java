...
public class Sueldo {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Total a cobrar: %.2f€\nSueldo: %.2f€\nVenta 1: %.2f€\nVenta 2: %.2f€\nVenta 3: %.2f€\nTotal comisiones: %.2f€",sueldo+(venta1*0.1)+(venta2*0.1)+(venta3*0.1),sueldo,venta1*0.1,venta2*0.1,venta3*0.1,(venta1*0.1)+(venta2*0.1)+(venta3*0.1));
